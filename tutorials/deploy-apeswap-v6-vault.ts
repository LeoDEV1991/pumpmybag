...
const want = web3.utils.toChecksumAddress("0xC087C78AbaC4A0E900a327444193dBF9BA69058E"); // Add the LP address.

const shouldVerifyOnEtherscan = true;

const vaultParams = {
  mooName: "Ape BUSD-USDC TokenX", // Update the mooName.
  mooSymbol: "tokenXAPEBUSD-USDC", // Update the mooSymbol.
  delay: 21600,
};
